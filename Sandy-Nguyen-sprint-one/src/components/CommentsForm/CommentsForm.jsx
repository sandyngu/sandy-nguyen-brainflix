        ...
        <>
            ...
            <div className="comments-section__container">
                    ...
                    <form className="comments-section__form">
                        ...
                        <br/><textarea type="text" className="comments-section__form-input comments-section__form-input-comment" name="comment" placeholder="Write comment here"></textarea>
